	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
				...
				<li id="navHome"     class="nav-item"><a class="nav-link" href="${contextRoot}/home">    Store   </a></li>
				...
				<li id="navCart"     class="nav-item"><a class="nav-link" href="${contextRoot}/cart">    Cart    </a></li>
			</ul>
		</div>
	</div>
